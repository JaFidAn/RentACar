using CoreCrossCuttingConcers.Logging.Serilog.ConfigurationModels;
using CoreCrossCuttingConcers.Logging.Serilog.Messages;
using Microsoft.Extensions.Configuration;
using Serilog;

namespace CoreCrossCuttingConcers.Logging.Serilog.Logger;
